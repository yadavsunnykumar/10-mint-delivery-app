/**
 * Patches every product in products.json with a correctly matched Unsplash image.
...
// product_id → verified Unsplash photo ID that visually matches the product
const IMAGE_MAP = {
  // ── Fruits & Vegetables ──────────────────────────────────────────────────
  1: "photo-1528825871115-3581a5387919", // Fresh Bananas           (was: wheat/bread image ❌)
  ...
  8: "photo-1610725664285-7c57e6eeac3f", // Tata Sampann Toor Dal    (was: ginger image ❌)
  25: "photo-1505253758473-96b7015fcd40", // Chana Dal
  26: "photo-1515562141207-7a88fb7ce338", // Organic Moong Dal        (was: generic food plate ❌)
  27: "photo-1536304929831-ee1ca9d44906", // Sona Masoori Rice        (unique rice photo)
  28: "photo-1574226882818-b27b0f3cf06f", // Multigrain Atta          (was: banana image ❌)
  ...
  30: "photo-1562280963-8a5475740a10", // Turmeric Powder (yellow spice — unique)
  31: "photo-1599599810769-bcde5a160d32", // Raisins Kishmish
  32: "photo-1596040033229-a9821ebd058d", // Red Chilli Powder

  // ── Breakfast & Sauces ───────────────────────────────────────────────────
  11: "photo-1521483451569-e33803c0330c", // Kellogg's Cornflakes     (cornflakes bowl)
  12: "photo-1472476443507-c7a5948772fc", // Kissan Ketchup            (was: masala spices ❌)
  33: "photo-1517673400267-0251440c45dc", // Quaker Oats               (was: rice image ❌)
  34: "photo-1472476443507-c7a5948772fc", // Maggi Hot & Sweet Sauce   (sauce bottle)
  35: "photo-1546069901-ba9599a7e63c", // Muesli Fruit & Nut        (muesli bowl)
  ...
  44: "photo-1587411768638-ec71f8e33b78", // Frozen Peas              (unique peas photo)
  45: "photo-1574158622682-e40e69881006", // Pizza Base Frozen
  46: "photo-1585032226651-759b368d7246", // Veg Momos Frozen

  // ── Home & Cleaning ──────────────────────────────────────────────────────
  15: "photo-1558618047-3c8c76ca7d13", // Surf Excel Detergent     (detergent box)
  ...
  50: "photo-1629011822867-e1e12c3cbf19", // Good Night Mosquito Liquid (spray/repellent)
  ...
  56: "photo-1594751543129-36c5a2d73e27", // Nerf Gun Blaster          (toy gun)
  ...
  64: "photo-1528360983277-13d401cdc186", // Head & Shoulders Shampoo (shampoo bottle)
  ...
  73: "photo-1621506289937-a8e4df240d0b", // Tropicana Orange Juice   (OJ carton/glass)
  74: "photo-1548839140-29a749e1cf4d", // Bisleri Mineral Water
  75: "photo-1532235238-8b04d1ab4024", // Red Bull Energy Drink    (energy drink can)
  ...
  79: "photo-1546173159-315724a39694", // Maaza Mango Drink         (was: OJ same as Tropicana ❌)
  ...
  86: "photo-1549931319-a545dcf3bc7c", // Multigrain Bread Loaf     (unique bread photo)
  87: "photo-1488477181946-6428a0291777", // Amul Masti Dahi           (different curd/yogurt)

  // ── Instant Food ─────────────────────────────────────────────────────────
  88: "photo-1569718212165-3a8278d5f624", // Maggi 2-Minute Noodles
  89: "photo-1547592180-85f173990554", // Knorr Tomato Soup
  90: "photo-1630390736891-4aee5cf027cb", // Poha Ready to Cook        (was: cornflakes ❌)
  91: "photo-1612929633738-8fe44f7ec841", // Cup Noodles Chicken       (was: same as Maggi ❌)
  92: "photo-1504674900247-0877df9cc836", // Upma Rava Instant Mix
  93: "photo-1585937421612-70a008356fbe", // Dal Makhani Ready to Eat  (was: same as Upma ❌)
  94: "photo-1563379926898-05f4575a45d8", // Pasta Instant Masala
  95: "photo-1589301760014-d929f3979dbc", // Biryani Instant Mix       (was: same as Pasta ❌)

  // ── Snacks & Munchies ────────────────────────────────────────────────────
  96: "photo-1566478989037-eec170784d0b", // Lay's Classic Salted Chips
  97: "photo-1575389583827-1e56d22f4b71", // Kurkure Masala Munch
  98: "photo-1621939514649-280e2ee25f60", // Haldiram's Aloo Bhujia   (was: same as Kurkure ❌)
  99: "photo-1499636136210-6f4ee915583e", // Oreo Original Biscuits
  100: "photo-1558961363-fa8fdf82db35", // Britannia Good Day Cashew (was: same as Oreo ❌)
  101: "photo-1513558161293-cdaf765ed2fd", // Cornitos Nachos Cheese    (was: same as Lay's ❌)
  102: "photo-1606923829579-0cb981a83e2c", // Mixed Dry Fruits Trail Mix
  103: "photo-1621939514649-280e2ee25f60", // Parle-G Biscuits          (was: same as Oreo ❌)
};
...
const updated = products.map((p) => {
  const photoId = IMAGE_MAP[p._id];
  if (
    photoId &&
    `photo-${photoId.replace("photo-", "")}` !==
      p.image.split("/")[3]?.split("?")[0]
  ) {
    fixed++;
    return {
      ...p,
...
console.log(`✅ Updated images for ${Object.keys(IMAGE_MAP).length} products`);
